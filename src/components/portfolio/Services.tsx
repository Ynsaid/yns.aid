...
const Services = () => {
  ...
  return (
    <section
      id="services"
      className="min-h-screen bg-gradient-to-br  py-20 px-6"
    >
        ...
        <div className="flex flex-wrap justify-center gap-8">
          {services.map((service, index) => (
            <motion.div
              ...
              className="w-[260px] bg-white/5 p-6 rounded-xl backdrop-blur-sm text-center hover:scale-105 transition-all duration-300"
            >
